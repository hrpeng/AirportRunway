...
class Queue
{
 public:
  ...
  -----------------------------------------------------------------------*/
    ...
    /*-----------------------------------------------------------------------
     Move node with given key value to the front of the queue (if any), if the
     value exists in the queue.
     
     Precondition:  Queue is nonempty.
     Postcondition: Node with the particular key value is at the front of the queue.
     -----------------------------------------------------------------------*/
    
    void merge_two_queues(Queue q2);
    /*-----------------------------------------------------------------------
     Merge another queue into this queue with the elements in order (small
     to large).
     
     Precondition: both the queue and the given queue are ordered from small 
     to large.
     Postcondition: Merged queue is returned with elements in order while
